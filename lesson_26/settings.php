<?
define('C_REST_CLIENT_ID','app.6393371bcc69e3.59535908');//Application ID
define('C_REST_CLIENT_SECRET','T7m0NNPsZaBdsD92elt32WXhjrDKag7VOTm1Smf00HRGiMzUVw');//Application key
// or
