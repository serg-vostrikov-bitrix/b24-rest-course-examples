<?php
define('C_REST_CLIENT_ID','app.63c1374418a383.70467846');//Application ID
define('C_REST_CLIENT_SECRET','91h89XYzZVIjYnzpCy6CGtgxWLfzIuMBzZWDpQzLjH9URiUGZe');//Application key
// or
