<?
define('C_REST_CLIENT_ID','app.6393212ca33ca0.76748227');//Application ID
define('C_REST_CLIENT_SECRET','vMniV2G7Msjha5yn0nciJy1ZwTBUN2cbZwWXYFhc335uIcTZjN');//Application key
// or
